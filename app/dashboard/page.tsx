            ...
            <div className="modal-body">
              ...
              {settingsTab === "account" && <>
                ...
                <div className="settings-row">
                  <div>
                    ...
                    <div className="settings-sub">{isPro ? "Unlimited audits · $20/mo" : "1 free audit total"}</div>
                  </div>
                  {isPro
              ...
              {settingsTab === "legal" && <>
                ...
                <div className="legal-block">
                  ...
                  <strong style={{color:"rgba(255,255,255,0.5)"}}>Subscriptions & Billing.</strong> Pro subscriptions are billed at $20/month. You may cancel at any time via the billing portal. Refunds are handled on a case-by-case basis — contact us at hello@ghostos.live.<br /><br />
