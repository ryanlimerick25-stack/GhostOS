  ...
  return (
    <div style={{minHeight:"100vh",background:"#04040a",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"DM Sans,sans-serif",padding:"24px"}}>
      <div style={{marginBottom:"32px",textAlign:"center"}}>
        ...
        <h1 style={{fontSize:"28px",fontWeight:700,color:"rgba(255,255,255,0.93)",margin:"0 0 8px",letterSpacing:"-0.02em"}}>Welcome back</h1>
        <p style={{fontSize:"15px",color:"rgba(255,255,255,0.35)",margin:0}}>Sign in to your GhostOS account</p>
      </div>
      <SignIn
        appearance={{
          variables: {
